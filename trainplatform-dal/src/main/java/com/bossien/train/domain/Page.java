...
public class Page<T> extends Base {
    ...
    public Page(Integer count, Integer page, Integer pageSize) {
        this.count = count;
        ...
        this.nextPage = (this.haveNext.intValue() == 1) ? this.page + 1 : this.page;
        this.havePre = (this.page > 1) ? 1 : 0;
        this.prePage = (this.havePre.intValue() == 1) ? this.page -1 : this.page;
        this.startNum = (this.page >= 1 ? this.page - 1 : 0) * this.pageSize;
        this.endNum = (this.page.intValue() == totalPages.intValue()) ? this.count : (this.page * this.pageSize);
    }
