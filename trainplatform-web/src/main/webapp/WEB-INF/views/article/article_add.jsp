        ...
        <div class="center-section">
            <form id="article_form">
                <div class="center-row clearfix">
                    ...
                    <input type="text" class="form-control center-store-right no-radius" name="title" placeholder="文章标题">
                </div>
                <div class="center-row clearfix">
                    <label class="center-lable">作者:</label>
                    <input type="text" class="form-control center-store-right no-radius" name="author" placeholder="作者" style="width: 120px;">
                </div>
                <div class="center-row clearfix">
                ...
                <div class="center-row clearfix">
                    ...
                    <input type="text" class="form-control center-store-right no-radius" name="orderNub" placeholder="序号" style="width: 80px;">
                </div>
                ...
                <div class="center-section">
                    <div class="center-btn-bar">
                        <button class="lk-btn lk-btn-blue w100Per" onclick="article.save();">保存</button>
                    </div>
                </div>
            </form>
        </div>
