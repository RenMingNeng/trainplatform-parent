...
<body class="main-bg">
<jsp:include page="${path}/common/menu" ><jsp:param name="menu" value="user"/></jsp:include>
<div class="lk-sub-nav">
    <ul class="sub-nav-ul">
        <li>
            <a href="${path}user" class="sub-nav-items<c:if test="${empty userType}"> sub-nav-hover</c:if>">所有账户</a>
        </li>
        <li>
            <a href="${path}user?userType=1" class="sub-nav-items<c:if test="${userType == '1'}"> sub-nav-hover</c:if>">管理员</a>
        </li>
        <li>
            <a href="${path}user?userType=2" class="sub-nav-items<c:if test="${userType == '2'}"> sub-nav-hover</c:if>">监管人员</a>
        </li>
        <li>
            <a href="${path}user?userType=3" class="sub-nav-items<c:if test="${userType == '3'}"> sub-nav-hover</c:if>">学员</a>
        </li>
    </ul>
</div>
...
<script type="text/javascript" src="<%=resourcePath%>assets/js/user/index.js"></script>
