...
function SelectCompany() {
    ...
    _this.templateArr = [];
    _this.page_size = 10;
    _this.page_size_arr = [10, 50, 100, 500, 1000, 5000];
    ...
    _this.initTable = function() {
        var list_url = appPath + "/super/selectCompany/company_list";
        page.init("select_company_form", list_url, "select_company_list", "select_company_page", 1, _this.page_size, _this.page_size_arr);
        page.goPage(1);
        page.list = function(dataList){
            ...
            if(dataList){
                ...
                for(var i=0; i< len; i++) {
                    item = dataList[i];
                    inner += '<tr>';
                    inner += '<td  width="60" class="pro_num">' + (i+1) + '</td>';
                    inner += '<td  width="60"><input type=\"checkbox\" name="companyBox" data-id="' + item['intId'] + '"></td>';
    ...
    _this.initEvent = function () {
        ...
        $("#btn_sure").click(function () {
            ...
            // 完成单位添加
            $.ajax({
                url : appPath + '/super/project_create/public/save_public_company',
                dataType : 'json',
                async : false,
                type : 'post',
                data : {
                ...
                success : function (data) {
                    ...
                    if (10000 == result) {
                        ...
                        if('1' == $("#type").val()){
                            parent.step_3.initTable_company();
                        }else{
