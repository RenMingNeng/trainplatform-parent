...
(function ($) {
    ...
    */      
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="editable-submit btn btn-info"><i class="fa fa-check"></i></button>'+
    '<button type="button" class="editable-cancel btn btn-info"><i class="fa  fa-times"></i></button>';
