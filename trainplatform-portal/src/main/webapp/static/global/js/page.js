...
function page() {
    ...
    _this.check = function () {
        ...
        var num = $("#" + _this.tbody_id).find("input[type=checkbox]:checked").length;
        if (num == tr_num) {
    ...
    _this.goPage = function () {
        var url = _this.list_url + "?" + $("#" + _this.param_form_id).serialize();
        var params = {'pageSize': _this.pageSize, 'pageNum': _this.pageNum};
        $.ajax({
            url: url,
            data: params,
            type: "post",
            ...
            success: function (rs) {
                ...
                if (!dataList || dataList.length < 1) {
                    $('#checkAll').prop("checked", false);
                    $("#" + _this.tbody_id).empty().html(_this.noList(length));
                    $("#" + _this.page_id).empty();
                    return
                }
                ...
                if (page == 1) {
                    page_inner += "<li id=\"first\" class=\"p-prev disabled first\"><a href='javascript:page.getPageByNum(1);'>首 页</a></li>";
                } else {
                    page_inner += "<li id=\"first\" class=\"p-prev first\"><a href='javascript:page.getPageByNum(1);'>首 页</a></li>";
                }
                if (havePre == 0) {
                    page_inner += "<li id=\"shangyiye\" class=\"p-prev disabled\" ><a href=\"javascript:;\"><i></i>上一页</a></li>";
                } else {
                    page_inner += "<li id=\"shangyiye\" class=\"p-prev\" ><a href=\"javascript:page.getPageByNum(" + (page - 1) + ");\"><i></i>上一页</a></li>";
                }
                if (haveNext == 1) {
                    page_inner += "<li class=\"p-next\"><a href=\"javascript:page.getPageByNum(" + (page + 1) + ");\">下一页<i></i></a></li>";
                } else {
                ...
                if (totalPages == page) {
                    ...
                    page_inner += "<li id=\"weiye\" class=\"p-next\"><a href=\"javascript:void(0);\" onclick=\"javascript:page.getPageByNum(" + totalPages + ");\">尾 页</a></li>";
                }
                page_inner += "<li class=\"total\"><span id=\"span_number\">第&nbsp;" + page + "&nbsp;页&nbsp;&nbsp;共&nbsp;" + totalPages + "&nbsp;页&nbsp;&nbsp;共&nbsp;" + count + "&nbsp;条&nbsp;";
                page_inner += "到<input type=\"text\" id=\"input_number\" class=\"page-txtbox\" />页&nbsp;";
    ...
    _this.refresh_cur_page = function () {
        _this.getPageByNum(_this.pageNum);
    };
