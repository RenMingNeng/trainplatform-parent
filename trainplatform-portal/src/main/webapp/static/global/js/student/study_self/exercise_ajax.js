...
function exercise_ajax(){
    ...
    _this.single_many_html = function (question, i) {
        ...
        //     html += '<a href="javascript:;" class="collect"><i class="fa fa-star on"></i> 收藏试题</a>&nbsp;&nbsp;';
        // }else{
        //     html += '<a href="javascript:;" class="collect"><i class="fa fa-star-o" ></i> 收藏试题</a>&nbsp;&nbsp;';
        // }
...
var exercise_ajax = new exercise_ajax();