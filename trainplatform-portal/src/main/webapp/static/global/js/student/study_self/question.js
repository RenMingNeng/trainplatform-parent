...
function question(){
    ...
    _this.setInterval = function(){
        ...
        var time = parseInt(Number(question.allTime) - Number(curTime));
    ...
    _this.submitExam = function(t){
        var message = _this.alertMessage("你确定提交考卷吗?");
        layer.open({
            type:1,
            title: false, // 不显示标题栏
            closeBtn: false,
    ...
    _this.save_paper = function (t) {
        ...
        var param = {"detail" : detail, "exam_no" : exam_no, "startTime" : _this.startTime};
    ...
    _this.checkLeave = function(){
        ...
        if(detail != ''){
            var url = appPath + '/student/studySelf/save_exercise.do';
