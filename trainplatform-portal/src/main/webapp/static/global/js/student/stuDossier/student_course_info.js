...
function student_course_info(){
    ...
    _this.initTable = function(){
        var list_url = appPath + "/student/student_course_list";
        ...
        page.list = function(dataList){
            ...
            for(var i=0; i< len; i++) {
                ...
                if(finish_status == -1){
                    ...
                    inner += '<td><span class=\"text-gray\">完成</span></td>';
                }
                inner += '</tr>';
            }
...
var student_course_info = new student_course_info();