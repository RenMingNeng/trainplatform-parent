    ...
    _this.goPage = function(pageNum) {
        ...
        $.ajax({
            ...
            success:function(rs){
                ...
                if(page == 1){
                    page_inner += "<li id=\"first\" class=\"p-prev disabled first\"><a href='javascript:page2.getPageByNum(1);'>首 页</a></li>";
                }else{
                    page_inner += "<li id=\"first\" class=\"p-prev first\"><a href='javascript:page2.getPageByNum(1);'>首 页</a></li>";
                }
                if(havePre == 0){
                    page_inner += "<li id=\"shangyiye\" class=\"p-prev disabled\" ><a href=\"javascript:;\"><i></i>上一页</a></li>";
                }else{
                    page_inner += "<li id=\"shangyiye\" class=\"p-prev\" ><a href=\"javascript:page2.getPageByNum("+(page-1)+");\"><i></i>上一页</a></li>";
                }
                if(haveNext==1){
                    page_inner += "<li class=\"p-next\"><a href=\"javascript:page2.getPageByNum("+(page+1)+");\">下一页<i></i></a></li>";
                }else{
                ...
                if(totalPages == page){
                    ...
                    page_inner += "<li id=\"weiye\" class=\"p-next\"><a href=\"javascript:void(0);\" onclick=\"javascript:page2.getPageByNum("+totalPages+");\">尾 页</a></li>";
                }
