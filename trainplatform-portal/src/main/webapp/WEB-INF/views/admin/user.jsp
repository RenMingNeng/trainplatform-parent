...
<div id="main">
  ...
  <div class="area">
    <div id="addr"><a href="javascript:;">人员管理</a></div>
    <div class="box">
          ...
          <div class="col-9 list">
            <form>
              <div class="clearfix search-group">
                <div class="pull-left">
                  <a href="javascript:;" class="btn btn-info">导入</a>
                  <a href="javascript:;" class="btn btn-info">导出</a>
                  <a href="javascript:;" class="btn btn-info">转移</a>
                  <a href="javascript:;" class="btn btn-info">离职</a>
                </div>
...
<script>
      ...
      var zNodes =[
          {id:1, pId:0, name:"[core] 基本功能 演示[core] 基本功能 演示[core] 基本功能 演示[core] 基本功能 演示", open:true},
