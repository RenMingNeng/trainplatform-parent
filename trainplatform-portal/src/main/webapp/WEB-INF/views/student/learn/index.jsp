...
.nav{display: none}
        ...
        .container .play_list .show_list  ul li .contect > ul li {
            cursor: pointer;
            color: #666;
            float: left;
            width: 50%;
...
<body onbeforeunload="onlineStudy.plusTime();">
...
<div class="container" style="z-index:10000;">
    ...
    <div class="play_list" >
        ...
        <div class="show_list" id="show_list" >
            ...
            <%--课程列表--%>
            <div class="active" style="overflow: auto;height: 925px;">
                <ul id="show_list_course">
                   <%-- <li>

                            <a href="javascript:;"><i class="fa fa-plus"></i>课程视频0001111</a>


                            <div>
                                <ul>
                                    <li><a href="javascript:;" data-href="http://storage-sit.bosafe.com/api/v1/file/download/b0452f46371f414c9be508abc853084f.m3u8">视频1.flv</a></li>
                                    <li><a href="javascript:;">课程文档0001.doc</a></li>
                                </ul>
                            </div >
                    ...
                    <li class=""><a href="javascript:;"><i class="fa fa-plus"></i>课程视频0002</a>

                            <div>
                                <ul>
                                    <li><a href="javascript:;" data-href="http://storage-sit.bosafe.com/api/v1/file/download/b0452f46371f414c9be508abc853084f.m3u8">视频2.flv</a></li>
                                    <li><a href="javascript:;">课程文档0001.doc</a></li>
                                </ul>
                            </div >
...
<script src="<%=resourcePath%>static/global/js/videojs/js/video.js"></script>
...
<script src="<%=resourcePath%>static/global/js/student/learn/online_study.js"></script>
...
//        var messenger = new Messenger('student_study', 'messenger');
        common.study_messenger_init();
         //在线学时
        onlineStudy.init("<%=basePath%>", $("#projectId").val(),  $("#userId").val(), $("#source").val());
