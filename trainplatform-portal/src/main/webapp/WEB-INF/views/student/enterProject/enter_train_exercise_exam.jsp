                ...
                <div class="box-body pd_b_10">
                   ...
                   <%-- <div class="row">
                        <div class="col-6 form-group">
                            <div class="enter_exam" id="online_study">
        ...
        <%--<div class="box-body pd_b_10 enter_exam" style="padding-left:0;">
            <div class="row">
                <div class="col-6 form-group">
                    ...
                    <div class="col-9 info"><a href="javascript:;"  id="wrongCount1"  onclick="common.goto_student_wrong('${param.projectId}');"><span style="color: #188eee;font-size: 18px;">${wrongCount}</span></a></div>
                </div>
                <div class="col-6 form-group">
                    <label class="col-3" style="cursor: pointer;" onclick="common.goto_student_collection('${param.projectId}');">我的收藏：</label>
                    <div class="col-9 info"><a href="javascript:;" id="collectCount1"  onclick="common.goto_student_collection('${param.projectId}');"><span style="color: #188eee;font-size: 18px;">${collectionCount}</span></a></div>
                </div>
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <table class="table pro_msg project_enter_table">
                    ...
                    <tr>
                        <th width="60">序号</th>
                        <th class="text-left" width="240">课程名称</th>
                        <th width="80">课时</th>
                        <th width="80">应修学时</th>
                        <th width="80">已修学时</th>
