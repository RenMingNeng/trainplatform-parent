...
<div class="main area clearfix">
    <div class="main_left">
        <dl class="down_time">
            ...
            <dd style="padding:10px;"><a href="javascript:;" onclick="window.close();" style="background: #2487de;color:#fff;border-radius: 3px;">关闭</a></dd>
        </dl>
        <dl class="card">
...
<script src="<%=resourcePath%>static/global/js/student/question/question_exercise_ajax.js"></script>
...
<script>
    $(function () {
        ...
        question_exercise_ajax.initMethod('question_body', appPath + '${url}', '${param.project_id}', '${param.course_id}');
