...
<body onbeforeunload="studentStudy.plusTime();">
...
<script src="<%=resourcePath%>static/global/js/student/study/student_study.js"></script>
...
//        var messenger = new Messenger('student_study', 'messenger');
        ...
        studentStudy.init("<%=basePath%>", $("#projectId").val(), $("#courseId").val(), $("#userId").val(), $("#source").val());
