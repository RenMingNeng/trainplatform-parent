      ...
      <div class="box-header clearfix">
        ...
        <div class="pull-right search-group">
          <span class="search">
                ...
                <button type="button" title="搜索" class="btn" onclick="student_course_info.search();">
                  <span class="fa fa-search"></span> 搜索
                </button>
          </span>
          <span>
              <a href="javascript:;" class="btn all" onclick="student_course_info.searchAll();"><span class="fa fa-th"></span> 全部</a>
          </span>
          <span>
            <a href="javascript:history.go(-1);" class="btn btn-info"  id="btn_back"><span class="fa fa-reply"></span> 返回</a>
          </span>
       ...
       <%-- <form id="project_course_info_form">
        ...
        <table class="table pro_msg admin_index_table">
          ...
          <tr>
            <th width="50">序号</th>
            <th>课程名称</th>
            <th width="110">应修学时</th>
            <th width="110">已修学时</th>
            <th width="110">答题学时</th>
            <th width="110">培训学时</th>
            <th width="60">总题量</th>
            <th width="70">已答题量</th>
            <th width="70">答对题量</th>
            <th width="86">答题正确率</th>
            <th width="70">完成状态</th>
          </tr>
          </thead>
...
<script src="<%=resourcePath%>static/global/js/student/stuDossier/student_course_info.js"></script>
<script>
    var page = new page();
    student_course_info.init(page, '${projectType}');
</script>
</body>
