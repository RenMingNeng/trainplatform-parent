                    ...
                    <ul class="clearfix sso_nav">
                        ...
                        <div>
                            <dl>
                                ...
                                <dd><a href="<%=basePath%>popup/companyRegister"  id="" target="_blank">注册新单位</a></dd>
                        ...
                        <li class="hand-hover">
                            ...
                            <div>
                                <dl>
                                    ...
                                    <dd><a href="<%=basePath%>static/guide/student/step_1.html" target="_blank">操作指导</a></dd>
                                </dl>
                            </div>
                        </li>
                            <%--<li>
                            <div id="account-setting" style="position: relative;cursor: pointer;">
                                ...
                                <div id="account-setting-layer" class="user-role-layer" >
                                    <ul class="box-shadow">
                                        ...
                                        <c:if test="${sessionScope.company_id == '-1'}">
                                        <li><a href="<%=basePath%>popup/companyRegister"  id="" target="_blank">注册新单位</a></li>
                                        ...
                                        <li><a href="<%=basePath%>static/guide/student/step_1.html" target="_blank">操作指引</a></li>
...
<div class="nav">
    <div class="area clearfix">
        <ul class="clearfix pull-left">
            <li><a href="<%=basePath%>student" class="<c:if test="${param.menu=='student'}">active</c:if>">首页</a></li>
            <li><a href="<%=basePath%>student/stu_archive" class="<c:if test="${param.menu=='stuarchive'}">active</c:if>" >我的培训</a></li>
            <li><a href="<%=basePath%>student/studySelf/stuCurseList" class="<c:if test="${param.menu=='selfcourse'}">active</c:if>">我的课程</a></li>
